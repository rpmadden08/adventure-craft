...
public class Textures {
	...
	public static Sprite[] darkDirtTextures;
	...
	public Textures() {
		try {
			...
			*/
			...
			darkDirtTextures = new Sprite[13]; Point pDarkDirt = new Point(16*TEXTURE_SIZE, 0);
			...
			Sprite[][] t = {grassTextures, dirtTextures, waterTextures, darkDirtTextures, holeTextures, sandTextures};
			Point[] pts = {pGrass, pDirt, pWater, pDarkDirt, pHole, pSand};
