...
public class YellowFlowersTile extends Tile {
	
	public YellowFlowersTile() {
		super();
		currentSpriteId = 0;
		sprites = Sprites.spriteCollections.get(Sprites.YELLOW_FLOWERS_TILE);
		margin = new Margin(9, 9, 12, 11);
		id = YELLOW_FLOWERS_TILE;
		layer = OBJECT_LAYER;
		z = Z_OBJECT;
		isDiggable = true;
