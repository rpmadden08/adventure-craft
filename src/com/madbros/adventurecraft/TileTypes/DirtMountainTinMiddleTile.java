...
public class DirtMountainTinMiddleTile extends CollisionTile {
	public DirtMountainTinMiddleTile() {
		super();
		currentSpriteId = 0;
		sprites = Sprites.spriteCollections.get(Sprites.DIRT_MOUNTAIN_TIN_MIDDLE_NEW);
		margin = new Margin(9, 9, 12, 11);
		id = DIRT_MOUNTAIN_TIN_MIDDLE;
	...
	public Tile createNew() {
		return new DirtMountainTinMiddleTile();
	}
}
