...
public class DirtMountainCopperMiddleTile extends CollisionTile {
	public DirtMountainCopperMiddleTile() {
		super();
		currentSpriteId = 0;
		sprites = Sprites.spriteCollections.get(Sprites.DIRT_MOUNTAIN_COPPER_MIDDLE_NEW);
		margin = new Margin(9, 9, 12, 11);
		id = DIRT_MOUNTAIN_COPPER_MIDDLE;
	...
	public Tile createNew() {
		return new DirtMountainCopperMiddleTile();
	}
}
