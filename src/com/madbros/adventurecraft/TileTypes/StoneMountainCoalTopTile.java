...
public class StoneMountainCoalTopTile extends CollisionTile {
	public StoneMountainCoalTopTile() {
		super();
		currentSpriteId = 0;
		sprites = Sprites.spriteCollections.get(Sprites.STONE_MOUNTAIN_COAL_TOP);
		margin = new Margin(9, 9, 12, 11);
		id = STONE_MOUNTAIN_COAL_TOP;
...
//		z = this.z + Math.max(layer / 100f, layer / 100f);
	...
	public Tile createNew() {
		return new StoneMountainCoalTopTile();
	}
}
