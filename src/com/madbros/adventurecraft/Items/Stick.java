...
public class Stick extends CraftItem {
	public Stick() {
		...
		itemsPossiblyCraftable = new int[]{COPPER_AXE, COPPER_HOE, COPPER_PICK, COPPER_SHOVEL, COPPER_SWORD,IRON_AXE, IRON_HOE, IRON_PICK, IRON_SHOVEL, IRON_SWORD, STONE_AXE, STONE_HOE, STONE_PICK, STONE_SHOVEL, STONE_SWORD, TIN_AXE, TIN_HOE, TIN_PICK, TIN_SHOVEL, TIN_SWORD, TORCH, WOODEN_AXE, WOODEN_HOE, WOODEN_PICK, WOODEN_SHOVEL, WOODEN_SWORD};
