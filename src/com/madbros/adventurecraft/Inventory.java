...
//		}
		...
		invBar[0].item = new WoodenSword();
		invBar[0].item.stackSize = 1;
		invBar[1].item = new BatWing();
		invBar[1].item.stackSize = 3;
		invBar[2].item = new GlassBottle();
		invBar[2].item.stackSize = 99;
		invBar[3].item = new Coal();
		invBar[3].item.stackSize = 99;
		invBar[4].item = new CactusSeed();
		invBar[4].item.stackSize =3;
		invBar[5].item = new Cauldron();
