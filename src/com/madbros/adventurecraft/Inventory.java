...
//		}
		...
		invBar[2].item = new Steak();
		invBar[2].item.stackSize = 1;
		invBar[3].item = new CookedSteak();
		invBar[3].item.stackSize = 1;
		invBar[4].item = new Honey();
		invBar[4].item.stackSize =1;
		invBar[5].item = new SlimeBall();
		invBar[5].item.stackSize = 1;
		invBar[6].item = new WormGuts();
		invBar[6].item.stackSize = 1;
		invBar[7].item = new StingerSword();
		invBar[7].item.stackSize = 1;
		invBar[8].item = new HealthPotion();
