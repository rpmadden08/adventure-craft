...
import com.madbros.tileminer.Items.Tools.*;
...
//		
		...
		invBar[1].item = new Copper();
		invBar[1].item.stackSize = 99;
		invBar[2].item = new CopperBar();
		invBar[2].item.stackSize = 99;
		invBar[3].item = new CopperLeggings();
		...
		invBar[8].item = new CopperHoe();
		invBar[8].item.stackSize = 58;
		invBar[9].item = new CopperArmor();
		invBar[9].item.stackSize = 58;
//		
		invBag[0].item = new StairsDown();
		invBag[0].item.stackSize = 1;
//		invBag[1].item = new CopperLeggings();
//		invBag[1].item.stackSize = 1;
//		invBag[2].item = new CopperBoots();
//		invBag[2].item.stackSize = 1;
		invBag[3].item = new CopperHelmet();
		invBag[3].item.stackSize = 1;
//		invBag[4].item = new Roof();
