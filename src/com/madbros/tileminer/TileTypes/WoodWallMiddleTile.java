...
public class WoodWallMiddleTile extends CollisionTile {
	public WoodWallMiddleTile() {
		super();
		currentSpriteId = 0;
		sprites = Sprites.spriteCollections.get(Sprites.WOOD_WALL_MIDDLE);
		margin = new Margin(9, 9, 12, 11);
		id = WOOD_WALL_MIDDLE_TILE;
		autoTileID = id;
		layer = ABOVE_LAYER_1;
		z = Z_ABOVE_LAYER;
		isDiggable = false;
