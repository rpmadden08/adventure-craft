...
public class StoneMountainCopperBottomTile extends CollisionTile {
	...
	public void deleteMe(int x, int y, Block[][] activeBlocks) {
		...
		item = ITEM_HASH.get(COPPER_ITEM).createNew();
		Game.collectibleController.add(COPPER_ITEM, Sprites.sprites.get(Sprites.COPPER_ITEM), collectibleRect2, 1, item.maxUses);
