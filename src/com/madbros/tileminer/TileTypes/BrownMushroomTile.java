...
public class BrownMushroomTile extends Tile {
	...
	public void deleteMe(int x, int y, Block[][] activeBlocks) {
		...
		Item item = ITEM_HASH.get(BROWN_MUSHROOM).createNew();
		Game.collectibleController.add(BROWN_MUSHROOM, Sprites.sprites.get(Sprites.BROWN_MUSHROOM), collectibleRect, 1, item.maxUses);
