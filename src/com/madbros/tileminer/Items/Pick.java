...
//				}
//			} else if(!isPlacementCollidingWithHero(Game.level.highlightedBlock, Game.level.tileBeingAttacked.layer) &&Game.level.tileBeingAttacked.isToolStrongEnough(this) && isInRange) {
//				swing();
//			} else if(!Game.hero.isAttacking && Game.hero.attackButtonReleased) {
//				Game.soundController.create("sounds/swordSwing1.wav", 0.5f);
//			}
