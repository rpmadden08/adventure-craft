...
public class CraftingMenu {
	...
	public int[] craftableList = {
		...
		FIRE_PIT, FIRE_STARTER, FURNACE, LEATHER_ARMOR,
		LEATHER_BOOTS, LEATHER_HAT, LEATHER_LEGGINGS, PLANK, ROOF, STAIRS_DOWN, STAIRS_UP,
		...
		TIN_SHOVEL, TIN_SWORD, TORCH, WOODEN_AXE, WOODEN_DOOR, WOODEN_FLOOR, WOODEN_HOE, WOODEN_PICK, 
		WOODEN_SHOVEL, WOODEN_SWORD, WOOD_WALL, LIFE_VIAL
	};
